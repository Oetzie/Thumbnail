<?php
	...
	$thumbnail = $modx->getService('thumbnail', 'Thumbnail', $modx->getOption('thumbnail.core_path', null, $modx->getOption('core_path').'components/thumbnail/').'model/thumbnail/');

	if ($thumbnail instanceOf Thumbnail) {
	    return $thumbnail->run($input, $scriptProperties);
	}
